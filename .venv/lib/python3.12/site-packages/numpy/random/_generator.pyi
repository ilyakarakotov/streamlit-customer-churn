...
class Generator:
    ...
    @overload
    def gamma(self, shape: _FloatLike_co, scale: _FloatLike_co = ...,
    ...
    @overload
    def noncentral_f(self, dfnum: _FloatLike_co, dfden: _FloatLike_co, nonc: _FloatLike_co,
                     size: None = ...) -> float: ...  # type: ignore[misc]
    ...
    @overload
    def noncentral_chisquare(self, df: _FloatLike_co, nonc: _FloatLike_co,
                             size: None = ...) -> float: ...  # type: ignore[misc]
